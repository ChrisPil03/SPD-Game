...
public class SlimeWithOldMan : MonoBehaviour
{
    ...
    private void OldManDialogue()
    {
        GameObject.FindGameObjectWithTag("SceneManager").GetComponent<TutorialComplete>().StartOldManDialogue();
    }
